...
* Template Post Type: post, programs, family
* The template for displaying all family engagement posts
*
		...
		<div class="light-blue-background aligncenter">
			<div class="site-info">
				...
				<div class="grid-wrapper-thirds">
					<div class="left">
						<p><b>Questions?</b> We would gladly accept questions regarding referrals, additional information and requests for presentation of services provided by LifeTies, Inc. by contacting Bridget Lewis-Burgess.</p>
					</div>
					<div class="right-section" style="margin: 1em auto; padding: 1em;">
						<h3 class="dark-blue font-boldest">Bridget Lewis-Burgess</h3>
						<p class="zero-margin gray">Family Engagement Coordinator</p>
						<h4 class="gray"> (609)  731-5201</h4>
						<h5 class="perform-care">
							<a href="mailto:blewis-burgess@lifeties.org" class="font-boldest orange ">blewis-burgess@lifeties.org</a>
						</h5>
					</div>
				</div>
			</div>
